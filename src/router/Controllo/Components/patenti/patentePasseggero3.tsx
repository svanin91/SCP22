...
const PatentePasseggero3 = (data: DataPatente) => {
    ...
    <div className=" h-[37.5rem] pl-4 pt-4">
      <ul className="space-y-3 flex flex-col">
        ...
        <li className="flex">
          ...
          {datiPatente.N_04_data_nascita_passeggero_3}
        </li>
        <li className="flex">
          <p className="pr-3 text-red-500">Luogo di nascita:</p>
          {datiPatente.N_05_luogo_nascita_passeggero_3}
        </li>
        <li className="flex">
          <p className="pr-3 text-red-500">Data emissione:</p>
          {datiPatente.N_06_data_emissione_documento_passeggero_3}
        </li>
        <li className="flex">
          <p className="pr-3 text-red-500">Data Scadenza:</p>
          {datiPatente.N_07_data_scadenza_documento_passeggero_3}
        </li>
        <li className="flex">
          <p className="pr-3 text-red-500">Rilasciata da:</p>
          {datiPatente.N_08_rilasciata_da_passeggero_3}
        </li>
        <li className="flex">
          <p className="pr-3 text-red-500">Numero documento:</p>
          {datiPatente.N_09_numero_documento_passeggero_3}
        </li>
        <li className="flex">
        ...
        <li className="flex">
          ...
          {datiPatente.N_11_annotazioni_restrizioni_passeggero_3}
        </li>
      </ul>
    </div>
  );
};
export default PatentePasseggero3;
