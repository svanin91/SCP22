...
const NuovoControllo = () => {
  ...
  const [
    stringaCategoriaPatenteConducente,
    setstringaCategoriaPatenteConducente,
  ] = useState("");
  const [
    stringaCategoriaPatentePasseggero_1,
    setstringaCategoriaPatentePasseggero_1,
  ] = useState("");
  const [
    stringaCategoriaPatentePasseggero_2,
    setstringaCategoriaPatentePasseggero_2,
  ] = useState("");
  const [
    stringaCategoriaPatentePasseggero_3,
    setstringaCategoriaPatentePasseggero_3,
  ] = useState("");
  const [
    stringaCategoriaPatentePasseggero_4,
    setstringaCategoriaPatentePasseggero_4,
  ] = useState("");
  const [
    stringaCategoriaPatentePasseggero_5,
    setstringaCategoriaPatentePasseggero_5,
  ] = useState("");
...
`;
   ...
   * PER OGNI TABELLA PARTE UN SCRIPT, CONTENETE IL NUMERO DOCUMENTO, CHE CREERà UN UNOVO RECORD VUOTO PER OGNI TABELLA CON ID DOCUMENTO QUELLO CHE GLI
   * VIENE PASSATO COME PARAMETRO, LO SCRIPT RESTITUIRà PER OGNI RECORD IN OGNI TABELLA UN IDRECORD FILEMAKER
  ...
  useEffect(() => {
    if (
      ...
      const arrayCategoriaPatente =
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_conducente;
      setstringaCategoriaPatenteConducente(arrayCategoriaPatente.join(","));
    }
    if (
      ControlloMyContext?.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_1
    ) {
      const arrayCategoriaPatente =
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_1;
      setstringaCategoriaPatentePasseggero_1(arrayCategoriaPatente.join(","));
    }
    if (
      ControlloMyContext?.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_2
    ) {
      const arrayCategoriaPatente =
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_2;
      setstringaCategoriaPatentePasseggero_2(arrayCategoriaPatente.join(","));
    }
    if (
      ...
      const arrayCategoriaPatente =
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_3;
      setstringaCategoriaPatentePasseggero_3(arrayCategoriaPatente.join(","));
    }
    if (
      ControlloMyContext?.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_4
    ) {
      const arrayCategoriaPatente =
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_4;
      setstringaCategoriaPatentePasseggero_4(arrayCategoriaPatente.join(","));
    }
    if (
      ControlloMyContext?.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_5
    ) {
      const arrayCategoriaPatente =
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_5;
      setstringaCategoriaPatentePasseggero_5(arrayCategoriaPatente.join(","));
    }
    ...
    try {
      await axios.patch("http://localhost:10100/createInformazioniGenerali", {
        ...
        id_record_informazioni_generali:
          NuovoControlloMyContext.id_record_informazioni_generali, // Utilizza la variabile scriptResult precedentemente definita
      });
    } catch (error) {
      console.error(
        "Errore durante la richiesta Informazioni generali primo:",
        error
      );
    }
    setLoading(false);
  ...
  const dataA3_02_TabRig_PatenteGuida = {
    fieldData: {
      ...
      N_10_categoria_patente_conducente: stringaCategoriaPatenteConducente,
      ...
      N_09_numero_documento_passeggero_1:
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_09_numero_documento_passeggero_1,
      N_10_categoria_patente_passeggero_1: stringaCategoriaPatentePasseggero_1,
      ...
      N_09_numero_documento_passeggero_2:
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_09_numero_documento_passeggero_2,
      N_10_categoria_patente_passeggero_2: stringaCategoriaPatentePasseggero_2,
      ...
      N_09_numero_documento_passeggero_3:
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_09_numero_documento_passeggero_3,
      N_10_categoria_patente_passeggero_3: stringaCategoriaPatentePasseggero_3,
      ...
      N_09_numero_documento_passeggero_4:
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_09_numero_documento_passeggero_4,
      N_10_categoria_patente_passeggero_4: stringaCategoriaPatentePasseggero_4,
      ...
      N_09_numero_documento_passeggero_5:
        ControlloMyContext.A3_02_TabRig_PatenteGuida_N_09_numero_documento_passeggero_5,
      N_10_categoria_patente_passeggero_5: stringaCategoriaPatentePasseggero_5,
    ...
    try {
      await axios.patch("http://localhost:10100/createCartaCircolazione", {
        ...
        id_record_cartaCircolazione:
          NuovoControlloMyContext.id_record_cartaCircolazione, // Utilizza la variabile scriptResult precedentemente definita
      });
    } catch (error) {
      console.error(
  ...
  const createImmagini = async () => {
    setLoading(true);
    try {
      for (const key in dataA4_01_TabRig_Immagini.fieldData) {
        const data = {
          fieldData: {
            [key]: dataA4_01_TabRig_Immagini.fieldData[key],
          },
        };

        if (data.fieldData[key] !== "") {
          await axios.patch("http://localhost:10100/createImmagini", {
            data,
            id_record_Immagini: NuovoControlloMyContext.id_record_Immagini,
          });
        }
      }
    } catch (error) {
  ...
  const submitData = () => {
    if (TabActiveMyContext.tabActive === "tab1") {
      if (!ControlloMyContext?.A2_TabRig_informazioni_generali_D_01_data) {
        return handleAuthenticationError(
          "Inserire la data di esecuzione del controllo"
        );
      } else if (
        !ControlloMyContext.A2_TabRig_informazioni_generali_D_12_nome_operatore
      ) {
        return handleAuthenticationError(
          "Selezionare l'operatore che ha effettuato il controllo"
        );
      } else if (
        !ControlloMyContext?.A2_TabRig_informazioni_generali_D_02_ora_inizio
      ) {
        return handleAuthenticationError(
          "Inserire l'orario di inzio del controllo"
        );
      } else if (
        !ControlloMyContext.A2_TabRig_informazioni_generali_D_03_ora_fine
      ) {
        return handleAuthenticationError(
          "Inserire l'orario di conclusione del controllo"
        );
      } else if (
        ...
        return handleAuthenticationError(
          "Non è stato specificato l'indirizzo dove é stato effettuato il controllo"
        );
      } else if (
        ...
        <div className="flex justify-between items-center">
          <div>
            <p className="text-2xl pl-4 flex ">
              Nuovo controllo {NuovoControlloMyContext.a_02a_n_record}
            </p>
          </div>
