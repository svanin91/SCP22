...
interface CartaIdentitaInitial {
  ...
  N_22_data_scadenza_documento_documento_passeggero_2: string;
  N_23_nome_cognome_madre_nel_caso_minore_passeggero_2: string;
  id_record: number;
}

const CartaIdentitaPasseggero2 = (props: { statoIniziale?: any }) => {
    ...
    <div className="max-h-[650px] w-full flex justify-center items-center">
      <ul className="space-y-0.5">
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_02_comune_ufficio_emettitore_passeggero_2}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <InputText
              initial={initialState?.N_04_nome_passeggero_2}
              thisState={
            ...
            />
            <InputText
              initial={initialState?.N_03_cognome_passeggero_2}
              thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <InputDate
              initial={initialState?.N_05_data_nascita_passeggero_2}
              thisState={
                ControlloMyContext.A3_03_TabRig_CartaIdentita_N_05_data_nascita_passeggero_2
              }
              thisSetState={
            ...
            />
            <InputLuogoNascita
              initial={initialState?.N_06_luogo_nascita_passeggero_2}
              thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-3 gap-10 items-center">
            <InputSesso
              initial={initialState?.N_08_sesso_passeggero_2}
              thisState={
            ...
            />
            <InputStatura
              initial={initialState?.N_09_statura_passeggero_2}
              thisState={
            ...
            />
            <InputColoreOcchi
              initial={initialState?.N_10_occhi_passeggero_2}
              thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <InputText
              initial={initialState?.N_11_cittadinanza_passeggero_2}
              thisState={
            ...
            />
            <InputCF
              initial={initialState?.N_12_codice_fiscale_passeggero_2}
              thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <InputText
              initial={initialState?.N_13_residenza_passeggero_2}
              thisState={
            ...
            />
            <InputText
              initial={initialState?.N_14_professione_passeggero_2}
              thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputStatoCivile
            initial={initialState?.N_15_stato_civile_passeggero_2}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={
              initialState?.N_16_eventuale_non_validita_per_espatrio_passeggero_2
            }
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={
              initialState?.N_17_nome_cognome_padre_nel_caso_minore_passeggero_2
            }
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={
              initialState?.N_23_nome_cognome_madre_nel_caso_minore_passeggero_2
            }
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_18_estremi_atto_nascita_passeggero_2}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_19_comune_di_iscrizione_AIRE_passeggero_2}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_20_numero_documento_passeggero_2}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div className="grid grid-cols-2 gap-10 items-center">
            <InputDate
              initial={initialState?.N_21_data_emissione_documento_passeggero_2}
              thisState={
                ControlloMyContext.A3_03_TabRig_CartaIdentita_N_21_data_emissione_documento_passeggero_2
              }
              thisSetState={
            ...
            <InputDate
              initial={
                initialState?.N_22_data_scadenza_documento_documento_passeggero_2
              }
              thisState={
                ControlloMyContext.A3_03_TabRig_CartaIdentita_N_22_data_scadenza_documento_passeggero_2
              }
              thisSetState={
