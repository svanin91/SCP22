...
const InputPatentePasseggero4 = (props: { statoIniziale?: any }) => {
  ...
  const catPatenteString = initialState?.N_10_categoria_patente_passeggero_4;
  ...
  const renderCatPatente =
    ControlloMyContext
      .A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_4.length > 0
      ? ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_4.map(
    ...
    <div className="h-[37.5rem] w-full flex justify-center items-center ">
      <ul className="space-y-2">
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_02_cognome_passeggero_4}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_03_nome_passeggero_4}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputDate
            initial={initialState?.N_04_data_nascita_passeggero_4}
            thisState={
              ControlloMyContext.A3_02_TabRig_PatenteGuida_N_04_data_nascita_passeggero_4
            }
            thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputLuogoNascita
            initial={initialState?.N_05_luogo_nascita_passeggero_4}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputDate
            initial={initialState?.N_06_data_emissione_documento_passeggero_4}
            thisState={
              ControlloMyContext.A3_02_TabRig_PatenteGuida_N_06_data_emissione_documento_passeggero_4
            }
            thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputDate
            initial={initialState?.N_07_data_scadenza_documento_passeggero_4}
            thisState={
              ControlloMyContext.A3_02_TabRig_PatenteGuida_N_07_data_scadenza_documento_passeggero_4
            }
            thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_08_rilasciata_da_passeggero_4}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_09_numero_documento_passeggero_4}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <div>
            <InputCatPatente
              initial={initialState?.N_10_categoria_patente_passeggero_4}
              thisState={
                ControlloMyContext.A3_02_TabRig_PatenteGuida_N_10_categoria_patente_passeggero_4
              }
              thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_11_annotazioni_restrizioni_passeggero_4}
            thisState={
...
export default InputPatentePasseggero4;
