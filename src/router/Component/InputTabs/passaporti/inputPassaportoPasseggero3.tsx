...
const InputPassaportoPasseggero3 = (props: { statoIniziale?: any }) => {
    ...
    <div className="h-[40rem] w-full flex justify-center items-center">
      <ul className="space-y-1.5">
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_02_tipo_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_03_codice_paese_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_04_numero_passaporto_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_05_cognome_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_06_nome_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_07_cittadinanza_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputDate
            initial={initialState?.N_08_data_nascita_passeggero_3}
            thisState={
              ControlloMyContext.A3_04_TabRig_Passaporto_N_08_data_nascita_passeggero_3
            }
            thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputLuogoNascita
            initial={initialState?.N_09_luogo_nascita_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputSesso
            initial={initialState?.N_10_sesso_passeggero_3}
            thisState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputDate
            initial={initialState?.N_11_data_emissione_documento_passeggero_3}
            thisState={
              ControlloMyContext.A3_04_TabRig_Passaporto_N_11_data_emissione_documento_passeggero_3
            }
            thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputDate
            initial={initialState?.N_12_data_scadenza_documento_passeggero_3}
            thisState={
              ControlloMyContext.A3_04_TabRig_Passaporto_N_12_data_scadenza_documento_passeggero_3
            }
            thisSetState={
        ...
        <li className="grid grid-cols-2 items-center">
          ...
          <InputText
            initial={initialState?.N_13_autorita_emittente_passeggero_3}
            thisState={
...
export default InputPassaportoPasseggero3;
