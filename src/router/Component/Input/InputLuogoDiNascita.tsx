...
const InputLuogoNascita = (props: {
  ...
  useEffect(() => {
    if (value?.value && value.value.description) {
      // Usa value.value.description se definito, altrimenti usa ""
      thisSetState(value.value.description);
    }
  }, [value, thisSetState]);
  return (
    <div className="relative">
      <GooglePlacesAutocomplete
        ...
        selectProps={{
          placeholder: initial ? initial : "Luogo di nascita",
          value,
          onChange: setValue,
...
export default InputLuogoNascita;
