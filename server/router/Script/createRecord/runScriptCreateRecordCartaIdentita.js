 ...
 */
const runScriptCreateRecordCartaIdentita = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_03_TabRig_CartaIdentita/script/update_records_A3_03_TabRig_CartaIdentita?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptCreateRecordCartaIdentita;
