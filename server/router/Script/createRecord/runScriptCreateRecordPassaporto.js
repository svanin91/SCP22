 ...
 * RECORD
 */
const runScriptCreateRecordPassaporto = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_04_TabRig_Passaporto/script/update_records_A3_04_TabRig_Passaporto?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptCreateRecordPassaporto;
