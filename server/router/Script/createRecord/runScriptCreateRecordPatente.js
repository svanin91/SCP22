 ...
 * RECORD
 */
const runScriptCreateRecordPatente = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_02_TabRig_PatenteGuida/script/update_records_A3_02_TabRig_PatenteGuida?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptCreateRecordPatente;
