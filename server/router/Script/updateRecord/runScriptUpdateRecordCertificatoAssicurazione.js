 ...
 */
const runScriptUpdateRecordCertificatoAssicurazione = async (
  token,
  req,
  res
) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_06_TabRig_CertificatoAssicurazione/script/A3_06_TabRig_CertificatoAssicurazione_corrente_obsoleto?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptUpdateRecordCertificatoAssicurazione;
