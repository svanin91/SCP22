 ...
 */
const runScriptUpdateRecordPatente = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_02_TabRig_PatenteGuida/script/A3_02_TabRig_PatenteGuida_corrente_obsoleto?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptUpdateRecordPatente;
