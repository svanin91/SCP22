 ...
 */
const runScriptUpdateRecordPassaporto = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_04_TabRig_Passaporto/script/A3_04_TabRig_Passaporto_corrente_obsoleto?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptUpdateRecordPassaporto;
