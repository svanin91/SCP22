 ...
 */
const runScriptUpdateRecordImmagini = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A4_01_TabRig_Immagini/script/A4_01_TabRig_Immagini_corrente_obsoleto?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptUpdateRecordImmagini;
