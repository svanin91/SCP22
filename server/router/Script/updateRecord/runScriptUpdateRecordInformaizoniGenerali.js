 ...
 */
const runScriptUpdateRecordInformazioniGenerali = async (token, req, res) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A2_TabRig_informazioni_generali/script/A2_TabRig_informazioni_generali_corrente_obsoleto?script.param=${req.body.A_02a_n_record}`;
  let config = {
    method: "GET",
...
export default runScriptUpdateRecordInformazioniGenerali;
