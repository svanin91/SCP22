 ...
 */
const runScriptDataDatiTabella = async (token) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_01_TabRig_DatiTabella/script/A3_03_TabRig_DatiTabella_data`;
  let config = {
    method: "GET",
...
export default runScriptDataDatiTabella;
