 ...
 */
const runScriptDataCertificatoAssicurazione = async (token) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_06_TabRig_CertificatoAssicurazione/script/A3_03_TabRig_CertificatoAssicurazione_data`;
  let config = {
    method: "GET",
...
export default runScriptDataCertificatoAssicurazione;
