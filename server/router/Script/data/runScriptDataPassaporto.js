 ...
 */
const runScriptDataPassaporto = async (token) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_03_TabRig_CartaIdentita/script/A3_03_TabRig_Passaporto_data`;
  let config = {
    method: "GET",
...
export default runScriptDataPassaporto;
