 ...
 */
const runScriptDataPatente = async (token) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_02_TabRig_PatenteGuida/script/A3_02_TabRig_PatenteGuida_data`;
  let config = {
    method: "GET",
...
export default runScriptDataPatente;
