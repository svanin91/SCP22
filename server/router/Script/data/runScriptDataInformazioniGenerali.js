 ...
 */
const runScriptDataInformazioniGenerali = async (token) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A2_TabRig_informazioni_generali/script/A3_02_TabRig_InformazioniGenerali_data`;
  let config = {
    method: "GET",
...
export default runScriptDataInformazioniGenerali;
