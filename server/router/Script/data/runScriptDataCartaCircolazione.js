...
const runScriptDataCartaCircolazione = async (token) => {
  const url = `https://srv04/fmi/data/v2/databases/SCP22/layouts/A3_05_TabRig_CartaCircolazione/script/A3_03_TabRig_CartaCircolazione_data`;
  let config = {
    method: "GET",
...
export default runScriptDataCartaCircolazione;
