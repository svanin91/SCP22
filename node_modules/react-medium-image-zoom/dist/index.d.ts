...
import { ReactNode, ElementType, ReactElement, ImgHTMLAttributes } from 'react';
...
declare function Controlled(props: ControlledProps): JSX.Element;

type UncontrolledProps = Omit<ControlledProps, 'isZoomed' | 'onZoomChange'>;
declare function Uncontrolled(props: UncontrolledProps): JSX.Element;
